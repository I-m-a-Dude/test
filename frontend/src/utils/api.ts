...
IMPORTANT NOTE
--------------
This analysis is automatically generated by an artificial intelligence model
and is intended for diagnostic assistance. Results must be validated by a
qualified radiologist before any clinical decision.

Model used: MedNeXt (MONAI) - BraTS 2024
Analysis date: ${new Date().toLocaleString('en-UK')}`;
}
