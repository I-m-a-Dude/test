...
export default function ResultPage() {
    ...
    if (!analysisResult || (file && fileName !== file.name)) {
      ...
      if (segmentationFile && !isViewingSegmentation) {
        ...
        toast({
          ...
          description: 'Se afișează acum rezultatul segmentării AI.',
        });
      }
    }
  ...
  const handleToggleView = () => {
    if (isViewingSegmentation && originalFile) {
      ...
      toast({
        title: 'Fișier original încărcat',
        description: 'Se afișează acum fișierul MRI original.',
      });
        ...
        <div className="flex items-center gap-4">
          {segmentationFile && (
            ...
            >
              ...
              {isViewingSegmentation ? 'Vezi Original' : 'Vezi Segmentare'}
            </Button>
          )}
      ...
      <main className="flex flex-1 overflow-hidden">
        <div className="flex-1 flex flex-col p-4 overflow-hidden min-w-0">
          <div className="w-full h-full bg-black/20 rounded-lg flex items-center justify-center overflow-hidden relative">
            ...
            {/* Indicator pentru tipul de vizualizare */}
            {segmentationFile && (
              <div className="absolute top-4 left-4 z-10">
                ...
                >
                  {isViewingSegmentation ? '🎯 Segmentare AI' : '📊 MRI Original'}
                </Badge>
              </div>
            )}
          </div>
        ...
        <div className="h-full w-full max-w-sm border-l border-border bg-card flex-shrink-0">
          <Card className="w-full h-full overflow-y-auto rounded-none border-none">
            <CardHeader>
              ...
              <CardDescription>
                Rezultatul analizei automate pentru segmentarea gliomelor post-tratament.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              {inferenceResult && (
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-sm">Performanță</h3>
                  </div>

                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="bg-muted/30 p-2 rounded">
                      <div className="text-muted-foreground">Preproces</div>
                      <div className="font-medium">{formatTime(inferenceResult.timing.preprocess_time)}</div>
                    </div>
                    <div className="bg-muted/30 p-2 rounded">
                      <div className="text-muted-foreground">Inferență</div>
                      <div className="font-medium">{formatTime(inferenceResult.timing.inference_time)}</div>
                    </div>
                    <div className="bg-muted/30 p-2 rounded">
                      <div className="text-muted-foreground">Postproces</div>
                ...
                <>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-semibold text-sm">Statistici Segmentare</h3>
                    </div>

                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Volum total:</span>
                      ...
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Voxeli segmentați:</span>
                        <span className="font-medium">
                    ...
                    {Object.entries(inferenceResult.segmentation_info.class_counts)
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs font-medium">Distribuție clase:</span>
                        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-semibold text-sm">Raport Detaliat</h3>
                </div>
